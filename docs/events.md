...
Returns grouped event windows alongside featured rewards. Events are separated into `current`, `upcoming`, and `ended` arrays; ended events remain visible for up to 30 days after their end time.
